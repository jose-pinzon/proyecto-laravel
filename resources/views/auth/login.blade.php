            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-5">
                        <div class="text-muted text-center mt-2 mb-3"><small>{{ __('Iniciar sesion:') }}</small></div>
                        <div class="btn-wrapper text-center">
                            ...
                            <picture class="">
                                <img src="{{asset('assets/img/flordelavida.png')}}"  style="background:black; border-radius:10px; width:100px" alt="">
                            </picture>
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small>
                                    Si se encuentra registrado coloque los datos correspondientes
                                    <br>
                                    Nombre de usuario: <strong>admin@gmail.com</strong> contraseña: <strong>secreto</strong>
                            </small>
                        </div>
