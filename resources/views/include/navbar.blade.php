    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default  dropdown-menu-right ">
            <div class="row shortcuts px-4">
                ...
                <a href="https://accounts.google.com/signin/v2/identifier?hl=es&service=analytics&continue=https%3A%2F%2Faccounts.google.com%2FManageAccount%3Fnc%3D1&flowName=GlifWebSignIn&flowEntry=AddSession" class="col-4 shortcut-item">
